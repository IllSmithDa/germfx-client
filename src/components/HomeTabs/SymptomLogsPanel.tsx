...
export default function SymptomLogsPanel({
  ...
  return (
    ...
    >
      <h2 className="truncate text-base font-semibold leading-5 text-[hsl(var(--foreground))] sm:text-lg sm:leading-6 mb-2 sm:mb-4">
        My Symptoms
      </h2>
      <div className="mb-4 space-y-3 sm:flex sm:items-center sm:justify-between sm:gap-3 sm:space-y-6">
