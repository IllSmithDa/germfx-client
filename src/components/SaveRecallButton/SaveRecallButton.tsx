...
export default function SaveRecallButton({
  recallId,
  initialSaved,
  ...
  }, [recallId, initialSaved, isAuthenticated]);
  ...
  async function handleToggleSave() {
    ...
    try {
      ...
      if (
        ...
        router.push("/recalls?limit=saved_items");
        return;
      }
  ...
  const buttonTitle = isAuthenticated ? buttonLabel : "Log in to save this recall";
